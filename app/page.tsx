...
export default function Home() {
  ...
  useEffect(() => { 
    ...
    // Subscribe to realtime match changes on match_scores
  ...
  return (
    <main className="min-h-screen bg-pink-50 text-pink-900 p-4 md:p-8">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {/* View Tabs */}
        <div className="flex bg-white p-1.5 rounded-2xl border border-pink-200 shadow-sm gap-1 overflow-x-auto">
          <button
            onClick={() => setActiveTab('leaderboard')}
            className={`flex-1 py-2.5 px-3 text-xs font-bold rounded-xl whitespace-nowrap transition ${
